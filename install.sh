...
if [ -x "$(command -v docker)" ]; then
  echo -e "Docker is already installed! \e[32mGreen"
  sudo docker version
else
  sudo apt-get update && sudo apt-get upgrade -y
  echo -e "I have updated your system \e[32mGreen"
  sudo apt-get -y install \
    ...
    lvm2
  echo -e "Adding the new repository \e[32mGreen"
  ...
  echo -e "Now, I install Docker and docker-compose \e[32mGreen"
  ...
  echo -e "Tada! All fine. Welcome aboard, captain. \e[32mGreen"
fi
